...
<header class="showcase">
    <h1 id="camp">MÉXICO PAIS DIVERSO Y CULTURAL</h1>
    <p class="info">
        Bienvenidos a este sitio de información en dónde obtendrá información turistica, cultural y geográfica 
        del maravilloso pais que es México.
        ...
        <div class="col s8">
          <div class="card green darken-4">
            <div class="card-image">
              <img src="images/MEXICO2.jpg" alt="" />
            </div>
            <div class="card-title">
              Sobre México...
            </div>
            <div class="card-content" >
              <h1 class="camp">México</h1>
              <p class="info" >
